...
function NoticesWidget({ onNavigate, urgentNotice }) {
      ...
      <div style={{padding:'14px 18px'}}>
        ...
        {filtered.map((n, i) => (
          <div key={n.id} style={{
            ...
            padding: n.urgent ? '12px' : undefined,
            border: n.urgent ? '1.5px solid #f0b0b0' : undefined,
            marginTop: n.urgent ? '4px' : undefined,
          }}>
            <div style={{display:'flex', alignItems:'flex-start', justifyContent:'space-between', gap:'8px', marginBottom:'8px'}}>
              <div style={{display:'flex', alignItems:'center', gap:'6px', flexWrap:'wrap', flex:1}}>
                {n.urgent && (
                  <span style={{fontSize:'10px', background:'#e05555', color:'white',
...
export default function Home({ onNavigate }) {
  ...
  useEffect(() => {
    // Check for urgent notice, show popup only once per session
  ...
  return (
    <div style={{maxWidth:'680px'}}>
      ...
      <SearchBox />
      <NoticesWidget onNavigate={onNavigate} urgentNotice={urgentNotice} />
